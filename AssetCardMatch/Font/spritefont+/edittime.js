...
function GetPluginSettings()
{
	return {
		...
		"id":			"SpriteFontPlus",
		"version":		"1.0",
		"description":	"Extends the native Sprite Font to provide easier configuration and editing",
		"author":		"Chris Kent",
		"help url":		"http://thechriskent.com",
		"category":		"General",
...
var property_list = [
	...
	new cr.Property(ept_text,	"Char width JSON",		"",			"JSON array of character widths."),
